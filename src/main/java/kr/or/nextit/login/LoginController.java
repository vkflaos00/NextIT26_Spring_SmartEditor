...
public class LoginController {
	...
	/*
	 * @RequestMapping("/login/join") public String join(Model model) {
	...
	/*
	 * @RequestMapping("/join/mailAuth") public String
	 * mailAuth(@ModelAttribute("member") MemberVO member) { return "/login/join"; }
	 */
